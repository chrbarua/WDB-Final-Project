...
ini_set('display_errors', 1);
    ...
    if (isset($_POST['submit'])) {
        ...
        $ORG_LOC = isset($_POST['ORG_LOC']) ? mysqli_real_escape_string($con, trim($_POST['ORG_LOC'])) : '';
        ...
        if (empty($ORG_NAME) || empty($ORG_CONTACT) || empty($ORG_PASS) || empty($ORG_EMAIL)) {
            ...
            $sql = "SELECT * FROM `ORGANIZER` WHERE `ORG_EMAIL`='$ORG_EMAIL' OR `ORG_NAME`='$ORG_NAME'";
...
if ($result) {
  ...
  $count = 0;
            ...
            if ($count == 0) {
                $sql1 = "INSERT INTO `ORGANIZER` (ORG_NAME, ORG_CONTACT, ORG_PASS, ORG_EMAIL, ORG_PHONE, ORG_LOC, ORG_REGTIME) VALUES ('$ORG_NAME',
